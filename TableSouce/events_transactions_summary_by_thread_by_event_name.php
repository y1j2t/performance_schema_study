...
return [
	...
	//https://dev.mysql.com/doc/refman/8.0/en/transaction-summary-tables.html
	'tableName' => 'events_transactions_summary_by_thread_by_event_name',
	'tableDesc' => '通过线程ID和事件名划分的事务事件总汇',
	'fields' => [
		'THREAD_ID' => [
			//
			'name' => '线程ID',
