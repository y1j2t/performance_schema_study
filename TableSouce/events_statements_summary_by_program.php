...
return [
	...
	'tableName' => 'events_statements_summary_by_program',
	'tableDesc' => '每个存储过程的语句事件',
	'fields' => [
		'OBJECT_TYPE' => [
			//EVENT','FUNCTION','PROCEDURE','TABLE','TRIGGER
			'name' => '对象类型',
			'desc' => 'EVENT','FUNCTION','PROCEDURE','TABLE','TRIGGER',
			'descInvUrl' => '',
			'link' => '',
			'linkDesc' => ''
		],
