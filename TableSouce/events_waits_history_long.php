<?php
/*
 The events_waits_history_long table contains N the most recent wait events that have ended globally, across all threads. Wait events are not added to the table until they have ended.
 ...
 events_waits_history_long表包含在所有线程中全局结束的最近的等待事件。等待事件直到结束才添加到表中。当表满时，当添加新行时，最老的行将被丢弃，而不管哪个线程生成了这两行。
*/
