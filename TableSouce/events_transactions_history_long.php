<?php
/*
 The events_transactions_history_long table contains the N most recent transaction events that have ended globally, across all threads. Transaction events are not added to the table until they have ended. 
 ...
 events_transactions_history_long表包含在所有线程中全局结束的最近的N个事务事件。事务事件在结束之前不会添加到表中。当表满时，当添加新行时，最老的行将被丢弃，而不管哪个线程生成了这两行。
*/
...
return [
	...
	'tableName' => 'events_transactions_history_long',
	'tableDesc' => '最近的总体事务事件',
	'fields' => [
		'THREAD_ID' => [
